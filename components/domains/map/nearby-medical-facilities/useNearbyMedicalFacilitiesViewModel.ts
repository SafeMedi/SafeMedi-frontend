...
interface NearbyMedicalFacilitiesLocationState {
...
export interface NearbyMedicalFacilitiesViewModel {
  readonly isLoadingLocation: boolean;
...
export function useNearbyMedicalFacilitiesViewModel(): NearbyMedicalFacilitiesViewModel {
  const [locationState, setLocationState] = useState<NearbyMedicalFacilitiesLocationState>({
